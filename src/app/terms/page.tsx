          ...
          <Stack direction="column" spacing={2}>
            ...
            <Stack direction="column" spacing={0.5}>
              ...
              >
                ...
                are 21 years of age or older. By using the Site, you represent
                and warrant that you are at least 21 years old.
              </Typography>
              <Typography
                sx={{
                  fontSize: "16px",
              ...
              >
                ...
                Site for any unlawful purpose or in violation of any local,
                state, national, or international law; post or transmit any
                content that is defamatory, obscene, pornographic, harmful, or
                otherwise objectionable; attempt to interfere with the operation
                of the Site or access any data or information not intended for
                you.
              </Typography>
            </Stack>
            <Stack direction="column" spacing={0.5}>
              ...
              >
                ...
                but not limited to event listings, comments, and messages) to
                the Site, you grant us a non-exclusive, royalty-free, perpetual,
                and worldwide license to use, reproduce, modify, and distribute
                the content in connection with the Site.
              </Typography>
              <Typography
                sx={{
                  fontSize: "16px",
              ...
              >
                <strong>Content Guidelines:</strong> All content submitted must
                be accurate, not misleading, and comply with all applicable laws
                and regulations. We reserve the right to remove any content that
            ...
            <Stack direction="column" spacing={0.5}>
              ...
              >
                <strong>Account Responsibility:</strong> If you choose to
                register (to post events), you are responsible for maintaining
                the confidentiality of your account information (including your
                Event ID) and for all activities that occur under your account.
              </Typography>
            </Stack>
            <Stack direction="column" spacing={0.5}>
              <Typography
            ...
            <Stack direction="column" spacing={0.5}>
              ...
              >
                ...
                and Conditions is found to be invalid or unenforceable, the
