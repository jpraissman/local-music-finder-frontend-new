    ...
    >
      ...
      >
        ...
        <Typography sx={{ fontSize: "18px", paddingTop: "20px" }}>
          ...
          everyone’s busy life. We can spend hours looking online but more often
          than not, don’t find anywhere to go and see live music which doesn’t
          help venues, musicians, or fans. <br />
          <br />
          And then it hit us – why not create a website that solves this problem
          by offering a convenient way to find live music near us which is how
          “TheLocalMusicFinder.com.” was born. <br /> <br />
          We are building an online community where venue owners/managers,
          musicians, and music fans can easily connect to promote and find local
          music. Posting events and finding them is not only simple, it is
          always up to date and will save everyone a great deal of time (See{" "}
          <Link href="/faqs">FAQs</Link> for instructions on both posting and
          finding events). <br />
          <br />
