        ...
        <Stack direction="column" spacing={4} sx={{ textAlign: "left" }}>
          ...
          <Stack direction="column" spacing={1}>
            ...
            >
              ...
              charge for any services on the site, you will be notified at least
              60 days in advance. We anticipate that if and when we start to
              charge for any services, there will always be certain services
              that remain free.
            </Typography>
          </Stack>
          <Stack direction="column" spacing={1}>
          ...
          <Stack direction="column" spacing={1.5}>
            ...
            >
              ...
              <br /> 2. Tell your customers, fans, and friends about us. <br />
            ...
            >
              ...
              TheLocalMusicFinder.com
              <br />
              3. Tell your friends looking to see local live music to check out
              TheLocalMusicFinder.com, and if you wouldn’t mind posting a link
              to our site on your social media accounts, that would be a huge
              help to us.
            </Typography>
          </Stack>
          <Stack direction="column" spacing={1}>
            ...
            >
              ...
              slightly different information provided by each, so we leave both
              up to give you the most information possible.
            </Typography>
          </Stack>
          <Stack direction="column" spacing={1}>
            <Typography
